        ...
        <div class="white">
            ...
            >
                <div class="media-body">
                    <div class="f3">
                        <span
                            class="fw6">{{ $user->posts()->where('status', \Botble\Base\Enums\BaseStatusEnum::PUBLISHED)->count() }}</span>
        ...
        <div class="white">
            ...
            >
                <div class="media-body">
                    <div class="f3">
                        <span
                            class="fw6">{{ $user->posts()->where('status', \Botble\Base\Enums\BaseStatusEnum::PENDING)->count() }}</span>
        ...
        <div class="white">
            ...
            >
                <div class="media-body">
                    <div class="f3">
                        <span
                            class="fw6">{{ $user->posts()->where('status', \Botble\Base\Enums\BaseStatusEnum::DRAFT)->count() }}</span>
