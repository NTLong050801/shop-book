                        ...
                        <div class="sidebar-profile">
                            <div class="avatar-container mb-2">
                                <div class="profile-image">
                                    <div
                                        class="avatar-view mt-card-avatar mt-card-avatar-circle"
                            ...
                            <div class="f6 mb3 light-gray-text">
                                <i
                                    class="fas fa-envelope mr2"></i>{{ Html::mailto($user->email, attributes: ['class' => 'gray-text']) }}
                            </div>
                            <div class="mb3">
                                <div class="light-gray-text mb2">
                                    <i
                                        class="fas fa-calendar-alt mr2"></i>{{ trans('plugins/member::dashboard.joined_on', ['date' => $user->created_at->format('F d, Y')]) }}
                                </div>
                                @if ($user->dob)
                                    <div class="light-gray-text mb2">
                                        <i
                                            class="fas fa-child mr2"></i>{{ trans('plugins/member::dashboard.dob', ['date' => $user->dob->format('F d, Y')]) }}
                                    </div>
                                @endif
                            </div>
                        </div>
