@if ($booking)
    <div class="row">
        ...
        <div class="col-md-6">
            <p><strong>{{ __('Hotel') }}</strong>: <i>@if ($booking->room->room->id) <a href="{{ $booking->room->room->url }}" target="_blank">{{ $booking->room->room->name }}</a> @else N/A @endif</i></p>
            <p><strong>{{ __('Room') }}</strong>: @if ($booking->room->roomOptionCategory->id) {{ $booking->room->roomOptionCategory->name }} @else N/A @endif</p>
            ...
            @endif
            <p><strong>{{ __('Booking Period') }}</strong>: <strong><i>{{ $booking->room->start_date }}</i></strong> -> <strong><i>{{ $booking->room->end_date }}</i></strong></p>
            @if ($booking->requests)
    ...
    <table class="table table-bordered">
        ...
        <tbody>
            <tr>
                ...
                <td style="vertical-align: middle">{{ $booking->room->roomOptionCategory->name }}</td>
