                            ...
                            <div class="inner-main">
                                <div class="inner-left w-100">
                                    <div class="inner-image">
                                        <a href="{{ $bookingInfo->room->url }}">
                                            {{ RvMedia::image($bookingInfo->room->image, $bookingInfo->room->name, 'room') }}
                                        </a>
                                    </div>
                                    <div class="inner-content">
                                        ...
                                        @if(!empty($bookingInfo->room->address))
                                            <div class="inner-address">
                                                <i class="fa-solid fa-location-dot"></i>
                                                <span>{{ $bookingInfo->room->address }}</span>
                                            </div>
                                        @endif
                                        @if(!empty($bookingInfo->room->phone))
                                            <div class="inner-address">
                                                <i class="fa-solid fa-phone"></i>
                                                <span>{{ $bookingInfo->room->phone }}</span>
                                            </div>
                                        @endif
                                        <div class="inner-tags">
                                            @foreach($bookingInfo->room->features as $feature)
                                                <a href="#">
                                                    {{ $feature->name }}
                                                </a>
                                            @endforeach
                        ...
                        <div class="form-checkout">
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        {{ $startDate->format('l') }} | {{ $startDate->format('d/m/Y') }}
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        {{ $endDate->format('l') }} | {{ $endDate->format('d/m/Y') }}
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        Phòng {{ $bookingInfo->roomOptionCategory->name }}
                                    </td>
                                </tr>
                                </tbody>
                            </table>
                            ...
                            <div class="inner-list">
                                <div class="inner-item">
                                    <div class="inner-text">
                                        <div class="inner-name">{{ $bookingInfo->roomOptionCategory->name }}</div>
        ...
        <div class="modal-content">
            <div class="modal-body">
                <div class="text-center">
                    ...
                    <div>
                        <p>Mã đặt phòng của bạn là: <span class="booking-code-color">{{$booking->transaction_id}}</span></p>
