<div class="checkout-detail">
            ...
            <div class="col-12">
                <div class="box-head">
                    ...
                    <div class="inner-desc font-italic">
                        Vui lòng kiểm kiểm tra lại các thông tin trước khi đặt phòng
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <form method="post" action="{{ route('public.booking.checkout') }}">
            ...
            <input type="hidden" name="room_option_category_id" value="{{ $product->room_option_category_id }}">
                                ...
                                <div class="inner-main">
                                    <div class="inner-left w-100">
                                        ...
                                        <div class="inner-content">
                                            ...
                                            @endif
                                            @if(!empty($product->room->phone))
                                                <div class="inner-address">
                                                    <i class="fa-solid fa-phone"></i>
                                                    <span>{{ $product->room->phone }}</span>
                                                </div>
                                            @endif
                            ...
                            <div class="form-checkout">
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="text-capitalize">{{ Carbon\Carbon::parse($startDate)->getTranslatedDayName() }}</span> | {{ $startDate->format('d/m/Y') }}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <span class="text-capitalize">{{ Carbon\Carbon::parse($endDate)->getTranslatedDayName() }}</span> | {{ $endDate->format('d/m/Y') }}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            1 Phòng {{ $product->roomOptionCategory->name }}
                                        </td>
                                    </tr>
                                    </tbody>
                                </table>
                                ...
                                <div class="inner-list">
                                    <div class="inner-item">
                                        <div class="inner-text">
                                            <div class="inner-name">{{ $product->roomOptionCategory->name }}</div>
                                            <div class="inner-quantity">{{ ceil($adults/2) }} phòng</div>
                                        </div>
                                    ...
                                    @if($children>0 || $babies>0)
                                        <div class="inner-item">
                                            <div class="inner-text">
                                                ...
                                                <div class="inner-quantity">{{ $children }} trẻ em + {{ $babies }} em bé</div>
                                            </div>
                                            <div class="inner-price">
