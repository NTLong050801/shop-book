...
@section('content')
    ...
    <div class="max-width-1200">
        ...
        <x-core-setting::section
            :title="trans('core/setting::setting.general.metas.title')"
            :description="trans('core/setting::setting.general.metas.description')"
        >
            <x-core-setting::form-group
                id="metas_tag"
            >
                <label
                    class="text-title-field"
                    for="admin_email"
                >{{trans('core/setting::setting.general.metas.add_meta')}}</label>
                <textarea
                    class="next-input"
                    id="metas_tag"
                    name="metas_tag"
                    rows="10"
                    placeholder="{{ trans('core/setting::setting.general.placeholder.add_metas_tag') }}"
                >{{ setting('metas_tag') }}</textarea>
            </x-core-setting::form-group>
        </x-core-setting::section>
